...
require __DIR__ . '/../../yiilesson/backend/config/bootstrap.php';

$config = yii\helpers\ArrayHelper::merge(
    require __DIR__ . '/../../yiilesson/common/config/main.php',
    require __DIR__ . '/../../yiilesson/common/config/main-local.php',
    require __DIR__ . '/../../yiilesson/backend/config/main.php',
    require __DIR__ . '/../../yiilesson/backend/config/main-local.php'
);

...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $date_day = Yii::$app->request->post('daysAgo', null);
        $model->setDateDays($date_day);

        $issues = Issue::find()->where(['>', 'created_at', strtotime($model->date_start)])->andWhere(['<', 'created_at', strtotime($model->date_end)])->all();
        $users = User::find()->all();
